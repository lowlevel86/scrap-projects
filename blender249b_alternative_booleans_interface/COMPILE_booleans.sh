...
g++ $DEFS $INCS $FLAGS -fPIC -c main_booleans.cpp -o $ROOTDIR/build/CMakeFiles/mesh_booleans.dir/main.cpp.o

/usr/bin/g++ -shared -O2 -g -DNDEBUG $ROOTDIR/build/CMakeFiles/mesh_booleans.dir/main.cpp.o -o mesh_booleans.so -Wl,-rpath,$ROOTDIR/build/gnu_9.4_cxx20_64_relwithdebinfo $ROOTDIR/build/gnu_9.4_cxx20_64_relwithdebinfo/libtbb.so.12.7 /usr/lib/x86_64-linux-gnu/libGL.so $ROOTDIR/build/imgui/libimgui.a $ROOTDIR/build/imgui/glfw/src/libglfw3.a /usr/lib/x86_64-linux-gnu/librt.so -lm -ldl /usr/lib/x86_64-linux-gnu/libX11.so -lpthread $ROOTDIR/build/shewchuk_predicates/libshewchuk_predicates.a
